...
"""Run like: python run_masterframe_commission_bias.py 2>&1 | tee 2026-02-13_masterframe_commission_bias_tee.log"""


OVERWRITE_CONFIG = True
OVERWRITE_DATA = False  # master flag
...
for date in dates:  # [::-1]:
    ...
    try:
        ...
        print(msg)
        print(tb)
        with open("2026-02-13_masterframe_commission_bias_errors.log", "a") as f:
            f.write(msg)
            f.write(tb)
