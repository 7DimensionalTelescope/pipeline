...
"""Run like: python run_masterframe_commission_sci.py 2>&1 | tee 2026-02-14_masterframe_commission_sci_tee.log"""
...
MASTER_FRAME_ONLY = True  # okay even if reducing sci images when giving list_of_images
TYPE = "sci"
BASE_PRIORITY = 10
...
query = """
    ...
    FROM survey_night
    WHERE date > '2023-10-09' AND date < '2024-02-15'
    ORDER BY date;
"""
...
for date in dates:  # [::-1]:
    ...
    try:
        ...
        print(msg)
        print(tb)
        with open("2026-02-14_masterframe_commission_sci_errors.log", "a") as f:
            f.write(msg)
            f.write(tb)
