...
"""Run like: python run_masterframe_commission_sci_rerun.py 2>&1 | tee 2026-02-19_masterframe_commission_sci_rerun_tee.log"""
...
MASTER_FRAME_ONLY = False  # okay even if reducing sci images when giving list_of_images
# TYPE = "sci"
BASE_PRIORITY = 10

dates = ["2023-10-18", "2023-10-19", "2023-10-22", "2023-10-23"]  # [::-1]
...
for date in dates:  # [::-1]:
    ...
    try:
        ...
        print(msg)
        print(tb)
        with open("2026-02-19_masterframe_commission_sci_rerun_errors.log", "a") as f:
            f.write(msg)
            f.write(tb)
