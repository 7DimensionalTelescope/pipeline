...
"""Run like: python run_masterframe_commission_flat.py 2>&1 | tee 2026-02-14_masterframe_commission_flat_tee.log"""
...
for date in dates:  # [::-1]:
    ...
    try:
        ...
        print(msg)
        print(tb)
        with open("2026-02-14_masterframe_commission_flat_errors.log", "a") as f:
            f.write(msg)
            f.write(tb)
